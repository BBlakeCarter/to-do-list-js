...
function createNewElement(task) {
	...
	checkbox.innerHTML = "<l class = 'material-icons'>check_box_outline_blank</l>";
	...
	editButton.innerHTML = "<l class = 'material-icons'>edit</l>";

	var deleteButton = document.createElement('button');
	deleteButton.className = "material-icons delete";
	deleteButton.innerHTML = "<l class = 'material-icons'>delete</l>";
...
function editTask() {
	...
	if (containsClass) {
		...
		editButton.innerHTML = "<l class = 'material-icons'>save</l>";
	}
